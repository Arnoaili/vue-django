  ...
  <el-row class="container">
    ...
    <el-col :span="24" class="topbar-wrap">
      <div class="topbar-logo topbar-btn">
        <a href="/"><img src="../assets/timg1.gif" style="width:40px;margin-top: 5px;border-radius:50%"></a>
      </div>
      ...
      <div class="topbar-account topbar-btn">
        <el-dropdown trigger="click">
          <span class="el-dropdown-link userinfo-inner"><i class="iconfont icon-yonghu"></i> {{sysUserName}} <i class="iconfont icon-xialahou-copy"></i></span>
          <el-dropdown-menu class="dropdown1" slot="dropdown">
            <el-dropdown-item><router-link to="/user/profile">注册</router-link></el-dropdown-item>
    ...
    <el-col :span="24" class="main">
      ...
      <aside :class="collapsed?'menu-collapsed':'menu-expanded'">
        ...
        <div class="menu-toggle" @click.prevent="collapse">
          ...
          <i class="iconfont icon-weibiaoti261" v-show="collapsed"></i>
        </div>
